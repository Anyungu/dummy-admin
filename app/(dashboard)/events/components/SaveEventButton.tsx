...
function SaveEventButton() {
    ...
    const data = {
        ...
        ...(specificEventStore?.location?.id ?? 0 > 0 ? { locationId: specificEventStore?.location?.id } : {}),
        ...(specificEventStore?.location?.id ?? 0 < 0 ? {} : { locationName: specificEventStore?.location?.name }),
        ...
        ...(specificEventStore?.team?.id ?? 0 > 0 ? { teamId: specificEventStore?.team?.id } : {}),
        ...(specificEventStore?.team?.id ?? 0 < 0 ? {} : { teamName: specificEventStore?.team?.name }),
        ...(specificEventStore?.secondTeam?.id ?? 0 > 0 ? { secondTeamId: specificEventStore?.secondTeam?.id } : {}),
        ...(specificEventStore?.secondTeam?.id ?? 0 < 0 ? {} : { secondTeamName: specificEventStore?.secondTeam?.name }),
        artistsIds,
        artistsNames,
        eventImageUrl: specificEventStore?.eventImageUrl,
        ...(specificEventStore?.gameName?.id ?? 0 > 0 ? { gameNameId: specificEventStore?.gameName?.id } : {}),
        ...(specificEventStore?.gameName?.id ?? 0 < 0 ? {} : { gameNameName: specificEventStore?.gameName?.name }),
        ...(specificEventStore?.eventName?.id ?? 0 > 0 ? { eventNameId: specificEventStore?.eventName?.id } : {}),
        ...(specificEventStore?.eventName?.id ?? 0 < 0 ? {} : { eventNameName: specificEventStore?.eventName?.name }),
    }
